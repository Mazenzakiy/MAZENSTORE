...
if ($request->getHas('id')) {
  ...
  $product=new Product;
 $prod= $product->selectId($id,"products.id AS prodId, products.name AS prodName,`desc`,cats.name AS catName,
                ...
                <div class="card-body p-5">
                    <form method="post" action="<?=AURL."handlers/edit-product.php";?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" class="form-control" value="<?=$prod['prodName'];?>">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Pieces</label>
                            <input type="number" name="pieces_no" class="form-control" value="<?=$prod['pieces_no'];?>">
                        </div>
                        ...
                        <div class="mb-3 d-flex justify-content-center">
                            <img src="<?=URL."uploads/".$prod['img'];?>" alt="" height="100px" >
                        </div>
