...
<?php
// here is the id to categories such as laptop , phones
					...
					<div class="product_grid">
						...
						<?php foreach ($prods as $prod) : ?>
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?= URL . "uploads/" . $prod['img']; ?>" alt="" height="100px"></div>
